...
declare module '@salesforce/core-bundle/config/configFile' {
   ...
   * ```
   */
  export class ConfigFile<T extends ConfigFile.Options = ConfigFile.Options, P extends ConfigContents = ConfigContents> extends BaseConfigStore<T, P> {
...
declare module '@salesforce/core-bundle/config/configStore' {
   ...
   */
  export abstract class BaseConfigStore<T extends BaseConfigStore.Options = BaseConfigStore.Options, P extends ConfigContents = ConfigContents> extends AsyncOptionalCreatable<T> implements ConfigStore<P> {
...
declare module '@salesforce/core-bundle/org/scratchOrgInfoApi' {
   ...
   */
  export const requestScratchOrgCreation: (hubOrg: Org, scratchOrgRequest: ScratchOrgInfo, settings: SettingsGenerator) => Promise<SaveResult>;
  /**
   ...
   * @returns {Promise<ScratchOrgInfo>}
   */
  export const pollForScratchOrgInfo: (hubOrg: Org, scratchOrgInfoId: string, timeout?: Duration) => Promise<ScratchOrgInfo>;
  /**
...
declare module '@salesforce/core-bundle/org/scratchOrgInfoGenerator' {
   ...
   */
  export const getAncestorIds: (scratchOrgInfo: ScratchOrgInfoPayload, projectJson: SfProjectJson, hubOrg: Org) => Promise<string>;
  /**
...
declare module '@salesforce/core-bundle/testSetup' {
  ...
  import { Logger } from '@salesforce/core-bundle/logger/logger';
  import { SfError } from '@salesforce/core-bundle/sfError';
  import { CometClient, CometSubscription, Message, StreamingExtension } from '@salesforce/core-bundle/status/streamingClient';
  import { SandboxFields } from '@salesforce/core-bundle/org/org';
  import { AuthFields } from '@salesforce/core-bundle/org/authInfo';
